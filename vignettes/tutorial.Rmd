...
Using *make_Mixture()* you can specify dynamic network evolutions. Picture 

by specifying changing governing dynamics in the sequences contained in the input parameters _mechanism_, _kind_, _parameter_, and _directed_.
