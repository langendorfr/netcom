grow_Mixture_properties <- function(sequence, disturbance = 0, p_ER = 0.5, power_PA = 2, divergence_DD = 0.8, link_DD = 0.2, divergence_DM = 0.8, mutation_DM = 0.4, link_DM = 0.2, rewire_SW = 0.1, connectance_NM = 1, retcon = FALSE, directed = TRUE, force_connected = FALSE) {
    ...
    for (x in 3:size) {
        ...
        for (d in 1:disturbance) {
            stir_Mixture_nodeLevel(matrix = matrix, 
    ...
    return(list(Ascendency = Ascendency, 
                ACratio = ACratio))
}
