#' @title Grow a Duplication and Divergence Network
#'
#' @description Grows an already existing network by adding a node according to the Duplication and Divergence mechanism. Nodes can only attach to previously grown nodes.
#'
